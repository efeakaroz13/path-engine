...
def home():
	return """
		<html>
			...
			<nav  class="collapse d-lg-block sidebar  bg-white" style="width:%20;position:fixed;left:0px;border-right:1px solid #000;height100%;">
              <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                  <a href="/" class="list-group-item list-group-item-action py-2 ripple" aria-current="true">
                    <i class="fas fa-tachometer-alt fa-fw me-3"></i><span>Dashboard</span>
                  </a>
                  <a href="/compile/android" class="list-group-item list-group-item-action py-2 ripple" aria-current="true">
                    <i class="fa-brands fa-android fa-fw  me-3"></i><span>Android Compiler</span>
                  </a>
                  <a href="/compile/windows" class="list-group-item list-group-item-action py-2 ripple" aria-current="true">
                    <i class="fa-brands fa-windows fa-fw  me-3"></i><span>Windows Compiler</span>
                  </a>
                  <a href="/compile/website" class="list-group-item list-group-item-action py-2 ripple" aria-current="true">
                    <i class="fa-brands fa-js fa-fw  me-3"></i><span>Website Compiler</span>
                  </a>
                  <a href="/compile/ios" class="list-group-item list-group-item-action py-2 ripple" aria-current="true">
                    <i class="fa-brands fa-app-store-ios fa-fw  me-3"></i><span>iOS Compiler</span>
                  </a>
